...
import com.shapp.www.interviewkazapp.folderpicker.FolderChooser;
import com.shapp.www.interviewkazapp.folderpicker.OnDirectorySelectedListerner;
...
public class SettingsPreferenceFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ListPreference camera = (ListPreference) findPreference(getString(R.string.camera_key));
        ...
        camera.setSummary(getValue(getString(R.string.camera_key),"Rare"));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        ...
        switch (pref.getTitleRes()) {
            ...
            case R.string.preference_camera_title:
                Log.d("MyTest", getValue(getString(R.string.camera_key), "0"));
                SharedPreferences.Editor editor = Main2Activity.sharedPref.edit();
                editor.putString("camera_type", getValue(getString(R.string.camera_key), "0"));
                editor.commit();
                break;
